...
class PCD_Align(nn.Module):
    ...
    def __init__(self, nf=64, groups=8):
        ...
        self.L3_dcnpack_1 = DCN_sep(nf, nf, nf, 3, stride=1, padding=1, dilation=1,
        ...
        self.L2_dcnpack_1 = DCN_sep(nf, nf,nf, 3, stride=1, padding=1, dilation=1,
                                    deformable_groups=groups)
        ...
        self.L1_dcnpack_1 = DCN_sep(nf, nf,nf, 3, stride=1, padding=1, dilation=1,
                                    deformable_groups=groups)
        ...
        self.L3_dcnpack_2 = DCN_sep(nf, nf,nf, 3, stride=1, padding=1, dilation=1,
                                    deformable_groups=groups)
        # L2: level 2, 1/2 spatial size
        ...
        self.L2_dcnpack_2 = DCN_sep(nf, nf,nf, 3, stride=1, padding=1, dilation=1,
                                    deformable_groups=groups)
        ...
        self.L1_dcnpack_2 = DCN_sep(nf, nf,nf, 3, stride=1, padding=1, dilation=1,
                                    deformable_groups=groups)
